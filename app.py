...
<html>
  <body style='font-family: Arial, sans-serif; color: #333;'>
    <div style='max-width: 600px; margin: auto; border: 1px solid #ccc; padding: 20px; border-radius: 10px;'>
      <div style='text-align: center;'>
        <img src='https://integraleacademy.com/wp-content/uploads/2023/11/cropped-integrale-academy-blanc.png' alt='Intégrale Academy' style='max-height: 80px;' />
      </div>
      <p>Bonjour <strong>{data['prenom']}</strong>,</p>
      <p>Nous avons bien reçu votre dossier. Il est en cours de traitement.</p>
      <p style='margin-top: 30px;'>Merci pour votre confiance,<br>L’équipe <strong>Intégrale Academy</strong></p>
    </div>
  </body>
</html>
